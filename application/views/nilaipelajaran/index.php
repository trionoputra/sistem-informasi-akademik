<div id="body-container">
	<div class="container">
		...
		<div class="form-filter">
				<form class="form-inline" method="get" action="<?php echo site_url("nilaipelajaran")?>" >
					...
					<div class="form-group">
						<select class="form-control input-sm" name="jenis_nilai">
						  <option value="all">Jenis Nilai</option>
						  <?php foreach ($jenis_nilai as $jn):?>
						  <option value="<?php echo $jn['id_jenis_nilai'];?>" <?php echo $this->input->get("jenis_nilai") == $jn['id_jenis_nilai'] ? ' selected' : '';?> ><?php echo $jn['des_jenis_nilai']?></option>
						  <?php endforeach;?>
						</select>
					</div>
					<div class="form-group">
					...
					<a href="<?php echo site_url("nilaipelajaran/manage")?>" class="btn btn-success btn-sm">Add New</a>
				</form>
			</div>
...
<!--			<th>Keterangan</th> -->
		...
		<?php foreach($data as $dt): ?>
		  <tr>
			...
			<td><?php echo $dt['des_jenis_nilai'];?></td>
			<td><?php echo $dt['nilai'];?></td>
<!--			<td><?php echo $dt['keterangan'];?></td> -->
			<td><?php echo $dt['thn_ajaran'];?></td>
			<th>
				<a class="btn btn-warning btn-xs" href="<?php echo site_url("nilaipelajaran/manage")."/". $dt['id_nilai']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
				<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("nilaipelajaran/delete")."/". $dt['id_nilai'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
			</th>
		  </tr>
		<?php endforeach ?>
		</tbody>
