<div id="body-container">
	<div class="container">
		...
		<div class="form-filter">
				<form class="form-inline" method="get" action="<?php echo site_url("absen")?>" >
					...
					<div class="form-group">
						<select class="form-control input-sm" name="alasan">
							<option value="all">alasan</option>
							<option value="i" <?php echo $this->input->get("alasan") == 'i' ? ' selected' : '';?> >Ijin</option>
							<option value="a" <?php echo $this->input->get("alasan") == 'a' ? ' selected' : '';?> >Alpha</option>
							<option value="s" <?php echo $this->input->get("alasan") == 's' ? ' selected' : '';?> >Sakit</option>
						</select>
					</div>
					<div class="form-group">
					...
					<a href="<?php echo site_url("absen/manage")?>" class="btn btn-success btn-sm">Add New</a>
				</form>
			</div>
		...
		<?php foreach($data as $dt): ?>
		  <tr>
			<td><?php echo date('d/m/Y',strtotime($dt['tgl_absen']));?></td>
		    <td><?php echo $dt['nis'];?></td>
			<td><?php echo $dt['nama'];?></td>
			<td><?php echo $dt['nm_kelas'];?></td>
			<td><?php echo $dt['semester'];?></td>
			<td><?php echo $dt['thn_ajaran'];?></td>
			<td><?php echo $dt['alasan'] == 'i' ? 'Ijin' : ($dt['alasan'] == 'a' ? 'Alpha' :'Sakit') ;?></td>
			<td><?php echo $dt['keterangan'];?></td>
			<th>
				<a class="btn btn-warning btn-xs" href="<?php echo site_url("absen/manage")."/". $dt['id_absen']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
				<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("absen/delete")."/". $dt['id_absen'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
			</th>
		  </tr>
		<?php endforeach ?>
		</tbody>
