...
<div id="body-container">
	<div class="container">
		...
		<?php endif; ?>
		<form  method="post" action="<?php echo site_url("guruspesialis/save")?>"  >
			<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $data->id_ajar; ?>" >
			<div class="panel panel-default form-master">
			  			...
			  			<div class="col-md-4  pull-right">
			  				<div class="form-action pull-right">
								...
								<button type="submit" class="btn btn-success" name="action" value="saveexit">Save & Exit</button>
			     				...
			     				<a  href="<?php echo site_url("guruspesialis")?>" class="btn btn-danger">Cancel</a>
			     			</div>
			  			</div>
			  		</div>
			  </div>
			  <div class="panel-body">
				<div class="form-horizontal" >
					...
					<div class="form-group">
						<label for="id_pelajaran" class="col-sm-2 control-label">Pelajaran</label>
						<div class="col-sm-2">
							<select class="form-control input-sm" name="id_pelajaran">
							  <?php foreach ($pelajaran as $pl):?>
							  <option value="<?php echo $pl['id_pelajaran'];?>" <?php echo $data->id_pelajaran == $pl['id_pelajaran'] ? ' selected' : '';?> ><?php echo $pl['deskripsi']?></option>
							  <?php endforeach;?>
							</select>
						</div>
					</div>
