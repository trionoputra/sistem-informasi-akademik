<div id="body-container">
	<div class="container">
		...
		<div class="form-filter">
				<form class="form-inline" method="get" action="<?php echo site_url("nilaiekskul")?>" >
					...
					<div class="form-group">
						<select class="form-control input-sm" name="ekskul">
						  <option value="all">Ekskul</option>
						  <?php foreach ($ekskul as $kls):?>
						  <option value="<?php echo $kls['id_ekskul'];?>" <?php echo $this->input->get("ekskul") == $kls['id_ekskul'] ? ' selected' : '';?> ><?php echo $kls['nm_ekskul']?></option>
						  <?php endforeach;?>
						</select>
					</div>
					<div class="form-group">
					...
					<a href="<?php echo site_url("nilaiekskul/manage")?>" class="btn btn-success btn-sm">Add New</a>
				</form>
			</div>
		...
		<?php foreach($data as $dt): ?>
		  <tr>
			...
			<th>
				<a class="btn btn-warning btn-xs" href="<?php echo site_url("nilaiekskul/manage")."/". $dt['id_nilaiekskul']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
				<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("nilaiekskul/delete")."/". $dt['id_nilaiekskul'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
			</th>
		  </tr>
		<?php endforeach ?>
		</tbody>
