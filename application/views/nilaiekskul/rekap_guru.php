<script>
	$(function(){
		 ...
		 $("select[name='semester']").change(function()
		 {
		  ...
		  $("select[name='ekskul']").change(function()
		 {
			 $('#filter-form').submit();
		 });
	});
...
<div id="body-container">
	<div class="container">
		...
		<div class="panel panel-default form-master">
			<form class="form-horizontal" method="get" action="<?php echo site_url("nilaiekskul/rekap/guru")?>" id="filter-form">
...
<!--							<button type="submit" class="btn btn-success" name="action" value="pdf">Export to PDF</button>  -->
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label for="ekskul" class="col-sm-2">Ekstrakulikuler</label>
					<div class="col-sm-2">
